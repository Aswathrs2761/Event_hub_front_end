  ...
  useEffect(() => {
   ...
   const fetchEvents = async () => {
      try {
        ...
        // Sort by latest date + time and take top 6
      ...
      <div className="flex items-center justify-between mb-12">
        <div>
          <h2 className="text-3xl md:text-4xl font-bold bg-linear-to-r from-white to-gray-300 bg-clip-text text-transparent">
            Upcoming <span className="bg-linear-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Events</span>
          </h2>
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="flex items-center justify-between mt-4 pt-4 border-t border-white/10">
                ...
                <button className="px-4 py-2 bg-linear-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-purple-500/25 transform hover:scale-105">
                  Get Tickets
                </button>
              </div>
            </div>
